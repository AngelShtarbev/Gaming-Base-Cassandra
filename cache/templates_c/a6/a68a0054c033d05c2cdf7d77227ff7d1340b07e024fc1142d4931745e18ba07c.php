...
class __TwigTemplate_b43abc12689a7a3515ccc794c374d53e8c36c1a99d29dbaa648e1cc2866762d3 extends Twig_Template
{
    ...
    <div class=\"col-lg-12\">
        ...
        echo "/";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["platforms"]) ? $context["platforms"] : null), 0, array(), "array"), "platforms_name", array(), "array"), "html", null, true);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["platform"]) {
            ...
            echo "\" alt=\"\">
                        ...
                        <div class=\"col-lg-6\">
                            <h4><a href=\"/game/";
            // line 25
            echo twig_escape_filter($this->env, $this->getAttribute($context["platform"], "game_id", array(), "array"), "html", null, true);
            echo "/";
            ...
            echo "</p>
                            <span class=\"badge\">";
            // line 28
            echo twig_escape_filter($this->env, $this->getAttribute($context["platform"], "platforms_name", array(), "array"), "html", null, true);
            echo "</span>
                        </div>
                    </div>
...
";
    ...
    {
        return array (  91 => 34,  79 => 28,  75 => 27,  71 => 26,  63 => 25,  57 => 22,  52 => 19,  48 => 18,  39 => 14,  33 => 13,  19 => 1,);
    }
}
/* <div class="container ">*/
/*     <div class="col-lg-12">*/
...
/*                         <span class="caret"></span></button>*/
/*                     <ul class="dropdown-menu">*/
/*                         <li><a href="/platform/{{platforms[0]['platforms_id']}}/{{platforms[0]['platforms_name']}}/">Newest First</a></li>*/
/*                         <li><a href="/platform/asc/{{platforms[0]['platforms_id']}}/{{platforms[0]['platforms_name']}}/">Oldest First</a></li>*/
/*                     </ul>*/
/*                 </div>*/
/*             </div>*/
...
/*                         </div>*/
/*                         <div class="col-lg-6">*/
/*                             <h4><a href="/game/{{platform['game_id']}}/{{platform['name']}}/">{{platform['name']}}</a></h4>*/
/*                             <span class="glyphicon glyphicon-time datePublished"></span> Date Released:{{ platform['date_added']}}*/
/*                             <p>{{ platform['deck'] }}</p>*/
/*                             <span class="badge">{{platform['platforms_name']}}</span>*/
/*                         </div>*/
/*                     </div>*/
/*                     <div class="horizontal2"></div>*/
/*             </div>*/

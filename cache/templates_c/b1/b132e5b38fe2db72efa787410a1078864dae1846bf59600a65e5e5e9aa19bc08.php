...
/* games/games_reviews_asc_content.twig */
class __TwigTemplate_eeea1842db8133ca53dec2daa1a1f2ee56f1dd4cd1f510fbdf7ec74088b280d2 extends Twig_Template
{
...
";
    ...
    {
        return "games/games_reviews_asc_content.twig";
    }
...
/*                             <a href="/game/reviews/asc/{{ game['game_id'] }}">*/
/*                             <img src="/assets/images/no-image.png" width="172" height="243">*/
/*                             </a>*/
/*                             {% elseif game['images'] %}*/
/*                             <a href="/game/reviews/asc/{{ game['game_id'] }}">*/
...
/*                         </div>*/
/*                         <div class="col-lg-9 gamesRenderList">*/
/*                             <a href="/game/reviews/asc/{{ game['game_id'] }}"><h4>{{ game['name'] }}</h4></a>*/
...
/*             <div class="col-lg-9 pagination">*/
/*              {% if previous > 0 %}*/
/*                 <a href="/games/reviews/asc/{{ previous }}">*/
/*                    <button class="btn btn-medium btn-primary pull-left">Previous</button>*/
/*                 </a>*/
/*              {% endif %}*/
/*              {% if next > 0 %}*/
/*                  <a href="/games/reviews/asc/{{ next }}">*/
/*                      <button class="btn btn-medium btn-primary pull-right">Next</button>*/
/*                  </a>*/
/*              {% endif %}*/
/*             </div>*/

...
/* games/games_date_added_desc_content.twig */
class __TwigTemplate_a9b1019bcbaffbce1d7d38abf11fa654fbd47b8fee47243abae8792b61741a1c extends Twig_Template
{
...
";
    ...
    {
        return "games/games_date_added_desc_content.twig";
    }
...
/*                             <a href="/game/date/desc/{{ game['game_id'] }}">*/
/*                             <img src="/assets/images/no-image.png" width="172" height="243">*/
/*                             </a>*/
/*                             {% elseif game['images'] %}*/
/*                             <a href="/game/date/desc/{{ game['game_id'] }}">*/
...
/*                         </div>*/
/*                         <div class="col-lg-9 gamesRenderList">*/
/*                             <a href="/game/date/desc/{{ game['game_id'] }}"><h4>{{ game['name'] }}</h4></a>*/

...
/* videos/videos_content_asc.twig */
class __TwigTemplate_916c311d4077524c93c3a16411f4286ae24d7d4fd6540c309ed512d7f8d07c79 extends Twig_Template
{
...
";
    ...
    {
        return "videos/videos_content_asc.twig";
    }
...
/*         <div class="col-lg-9 pagination">*/
/*             {% if previous > 0 %}*/
/*                 <a href="/videos/asc/{{ previous }}">*/
/*                     <button class="btn btn-medium btn-primary pull-left">Previous</button>*/
/*                 </a>*/
/*             {% endif %}*/
/*             {% if next > 0 %}*/
/*                 <a href="/videos/asc/{{ next }}">*/
/*                     <button class="btn btn-medium btn-primary pull-right">Next</button>*/
/*                 </a>*/
/*             {% endif %}*/
/*         </div>*/

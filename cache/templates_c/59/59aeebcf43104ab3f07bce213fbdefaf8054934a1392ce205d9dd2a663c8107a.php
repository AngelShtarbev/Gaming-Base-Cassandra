...
/* games/games_title_asc_content.twig */
class __TwigTemplate_061146410b98fdfb2f6d78083591b946a463c934040835387690c0532da59f90 extends Twig_Template
{
...
";
    ...
    {
        return "games/games_title_asc_content.twig";
    }
...
/*                             <a href="/game/title/asc/{{ game['game_id'] }}">*/
/*                             <img src="/assets/images/no-image.png" width="172" height="243">*/
/*                             </a>*/
/*                             {% elseif game['images'] %}*/
/*                             <a href="/game/title/asc/{{ game['game_id'] }}">*/
...
/*                         </div>*/
/*                         <div class="col-lg-9 gamesRenderList">*/
/*                             <a href="/game/title/asc/{{ game['game_id'] }}"><h4>{{ game['name'] }}</h4></a>*/
...
/*             <div class="col-lg-9 pagination">*/
/*              {% if previous > 0 %}*/
/*                 <a href="/games/title/asc/{{ previous }}">*/
/*                    <button class="btn btn-medium btn-primary pull-left">Previous</button>*/
/*                 </a>*/
/*              {% endif %}*/
/*              {% if next > 0 %}*/
/*                  <a href="/games/title/asc/{{ next }}">*/
/*                      <button class="btn btn-medium btn-primary pull-right">Next</button>*/
/*                  </a>*/
/*              {% endif %}*/
/*             </div>*/

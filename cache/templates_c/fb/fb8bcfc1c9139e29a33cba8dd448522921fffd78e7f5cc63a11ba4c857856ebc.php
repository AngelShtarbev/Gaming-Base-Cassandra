...
/* reviews/reviews_content_score_asc.twig */
class __TwigTemplate_fbbc07fadebe13b493f24505c5de6f7be03a7be1fb05b5138cd16f40fd233416 extends Twig_Template
{
...
";
    ...
    {
        return "reviews/reviews_content_score_asc.twig";
    }
...
/*         <div class="col-lg-9 pagination">*/
/*             {% if previous > 0 %}*/
/*                 <a href="/reviews/score/asc/{{ previous }}">*/
/*                     <button class="btn btn-medium btn-primary pull-left">Previous</button>*/
/*                 </a>*/
/*             {% endif %}*/
/*             {% if next > 0 %}*/
/*                 <a href="/reviews/score/asc/{{ next }}">*/
/*                     <button class="btn btn-medium btn-primary pull-right">Next</button>*/
/*                 </a>*/
/*             {% endif %}*/
/*         </div>*/

...
/* reviews/reviews_content_score_desc.twig */
class __TwigTemplate_1d047609421eda0de6d29f436b54a7636d6ff4aeaa0ebbe7e83e9dbd5e717dc6 extends Twig_Template
{
    ...
    <div class=\"col-lg-12\">
        <div class=\"col-lg-9 pagination\">
            ...
            if (((isset($context["previous"]) ? $context["previous"] : null) > 0)) {
                // line 76
                echo "                <a href=\"/reviews/score/desc/";
...
";
    ...
    {
        return "reviews/reviews_content_score_desc.twig";
    }
...
/*         <div class="col-lg-9 pagination">*/
/*             {% if previous > 0 %}*/
/*                 <a href="/reviews/score/desc/{{ previous }}">*/
/*                     <button class="btn btn-medium btn-primary pull-left">Previous</button>*/
/*                 </a>*/
/*             {% endif %}*/
/*             {% if next > 0 %}*/
/*                 <a href="/reviews/score/desc/{{ next }}">*/
/*                     <button class="btn btn-medium btn-primary pull-right">Next</button>*/
/*                 </a>*/
/*             {% endif %}*/
/*         </div>*/

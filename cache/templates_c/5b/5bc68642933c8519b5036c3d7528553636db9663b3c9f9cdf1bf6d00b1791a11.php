...
/* games/games_reviews_desc_content.twig */
class __TwigTemplate_3a190a2c957cba72dc88a1304c7b1eb0bd40c53d8ef05d55cee677545beeec05 extends Twig_Template
{
...
$context["game"], "platforms_name", array(), "array")) {
        ...
        <div class=\"col-lg-12\">
            ...
            if (((isset($context["previous"]) ? $context["previous"] : null) > 0)) {
                // line 84
                echo "                <a href=\"/games/reviews/desc/";
...
";
        ...
        } elseif ( !twig_test_empty(        // line 111
...
";
    ...
    {
        return "games/games_reviews_desc_content.twig";
    }
    ...
    {
        return array (  234 => 112,  232 => 111,  216 => 97,  214 => 96,  209 => 93,  201 => 89,  198 => 88,  190 => 84,  188 => 83,  181 => 78,  169 => 74,  161 => 73,  158 => 72,  154 => 71,  147 => 66,  136 => 60,  133 => 59,  124 => 57,  119 => 56,  117 => 55,  114 => 54,  112 => 53,  109 => 52,  103 => 50,  101 => 49,  98 => 48,  96 => 47,  91 => 45,  85 => 44,  81 => 42,  75 => 39,  70 => 38,  68 => 37,  61 => 34,  59 => 33,  54 => 30,  50 => 29,  21 => 2,  19 => 1,);
    }
}
/* {% if message is empty %}*/
/* <!-- Page Content -->*/
...
/*                             <a href="/game/reviews/desc/{{ game['game_id'] }}">*/
/*                             <img src="/assets/images/no-image.png" width="172" height="243">*/
/*                             </a>*/
/*                             {% elseif game['images'] %}*/
/*                             <a href="/game/reviews/desc/{{ game['game_id'] }}">*/
...
/*                         </div>*/
/*                         <div class="col-lg-9 gamesRenderList">*/
/*                             <a href="/game/reviews/desc/{{ game['game_id'] }}"><h4>{{ game['name'] }}</h4></a>*/
...
/*             <div class="col-lg-9 pagination">*/
/*              {% if previous > 0 %}*/
/*                 <a href="/games/reviews/desc/{{ previous }}">*/
/*                    <button class="btn btn-medium btn-primary pull-left">Previous</button>*/
/*                 </a>*/
/*              {% endif %}*/
/*              {% if next > 0 %}*/
/*                  <a href="/games/reviews/desc/{{ next }}">*/
/*                      <button class="btn btn-medium btn-primary pull-right">Next</button>*/
/*                  </a>*/
/*              {% endif %}*/
/*             </div>*/
